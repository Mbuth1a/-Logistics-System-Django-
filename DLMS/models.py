...
class Product(models.Model):
    ...
    metres = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    weight_per_metre = models.DecimalField(max_digits=10, decimal_places=2)

    def __str__(self):
        return f"({self.stock_code}) ({self.product})  ({self.description})  ({self.unit_of_measure}) ({self.metres}) ({self.weight_per_metre})"
